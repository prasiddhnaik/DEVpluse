...
You are starting implementation of **DevPulse**.

DevPulse is a local-first developer runtime discovery tool. Its goal is to automatically discover local development projects, processes, ports, resource usage, and service-to-service socket relationships, then expose that state to a live T3 dashboard.
