...
use runscape_core::ids::{EventId, ServiceId};
use runscape_core::model::{EventKind, Health, RunscapeEvent};
...
fn file_changed(secs: u64, sequence: u32) -> RunscapeEvent {
    RunscapeEvent {
        ...
        kind: EventKind::FileChanged {
            ...
            path: "/tmp/runscape-fixture/src/main.rs".into(),
        },
    }
}

fn restarted(secs: u64, sequence: u32, service_id: &ServiceId) -> RunscapeEvent {
    RunscapeEvent {
        id: EventId::new(1_700_000_000_000 + secs * 1_000, sequence),
        at: at(secs),
        project_id: Some(project().id),
...
fn health_changed(secs: u64, sequence: u32, service_id: &ServiceId) -> RunscapeEvent {
    RunscapeEvent {
        id: EventId::new(1_700_000_000_000 + secs * 1_000, sequence),
        at: at(secs),
        project_id: Some(project().id),
...
async fn state_with_the_story() -> (AppState, RunscapeEvent) {
