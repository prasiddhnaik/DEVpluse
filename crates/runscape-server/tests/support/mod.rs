...
pub fn project() -> Project {
    Project {
        id: ProjectId::derived("/tmp/runscape-fixture"),
        root: "/tmp/runscape-fixture".into(),
        name: "runscape-fixture".to_string(),
...
pub fn service(name: &str, port: u16, pid: u32) -> Service {
    ...
    Service {
        ...
        instances: vec![ProcessInstance {
            ...
            cwd: Some("/tmp/runscape-fixture".into()),
            started_at_epoch_secs: 1_700_000_000,
            cpu_percent: 1.5,
            memory_bytes: 40 * 1024 * 1024,
            virtual_memory_bytes: 80 * 1024 * 1024,
            thread_count: Some(8),
            disk_read_bytes: 0,
            disk_write_bytes: 0,
        }],
