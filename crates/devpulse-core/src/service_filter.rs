...
//!
//! DevPulse promises to show *services*, not every process on the machine. A
...
//! either: DevPulse cannot say what it is, and guessing is not an option
//! (`AGENTS.md` rule 3).
...
pub fn is_service_process(
    ...
    // An unknown uptime is treated as too young: DevPulse would rather show a
...
mod tests {
    ...
    fn developer_software_is_a_service_once_it_has_stuck_around() {
        ...
        // it is the source end of most edges DevPulse draws.
        for binary in [
