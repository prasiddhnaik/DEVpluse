//! Runscape Docker inspection (Milestone 6).
//!
...
//! ```
//!
//! Containers reach the graph through the same [`Service`](runscape_core::Service)
...
pub use runscape_core::ContainerIdentity;
