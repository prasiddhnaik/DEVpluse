...
pub use model::{
    Connection, Endpoint, EventKind, Evidence, EvidenceType, Health, HostSample, ProcessInstance,
    Project, Protocol, ResourcePeaks, ResourceSample, RunscapeEvent, Service, ServiceKind,
    Severity, Warning,
};
pub use project::{
...
pub use resources::{HostHistory, ResourceHistory};
