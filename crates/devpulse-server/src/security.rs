...
//! `http://127.0.0.1:7778`. Without an origin check, a random website could
...
impl Default for OriginPolicy {
    fn default() -> Self {
        Self::new(&["http://localhost:3000", "http://127.0.0.1:3000"])
    }
}
...
/// Default bind address: `127.0.0.1:7778` (`TASKS.md` T3.1).
