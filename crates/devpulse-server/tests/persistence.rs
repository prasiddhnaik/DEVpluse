...
use devpulse_server::persistence::{Persistence, TickWrite, restore};
...
fn event(secs: u64, sequence: u32) -> DevPulseEvent {
    DevPulseEvent {
    ...
    for i in 0..50u64 {
        store
            .record_resource_samples(&[(
                service_id.clone(),
                devpulse_core::model::ResourceSample {
