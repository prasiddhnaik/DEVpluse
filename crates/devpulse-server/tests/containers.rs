...
use devpulse_core::model::ServiceKind;
use devpulse_docker::collector::ContainerCollector;
use devpulse_docker::container::{ContainerPort, ContainerSnapshot, ContainerState};
use devpulse_docker::error::DockerError;
use devpulse_docker::{ContainerIdentity, ObservedContainer};
use devpulse_server::snapshot::{SnapshotConfig, SnapshotLoop};
...
fn container(name: &str, service: &str, state: ContainerState, port: u16) -> ObservedContainer {
    ObservedContainer {
        ...
        ports: vec![ContainerPort {
            ...
            protocol: devpulse_core::Protocol::Tcp,
